...
import static df.navodyami.Activity_UserManual_DownloadPDF.key_usermanualpdfurl;
import static df.navodyami.Activity_UserManual_DownloadPDF.sharedpreferenc_usermanual;
...
public class Activity_ViewUserManualPDF_Downloaded_pdf extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener {
    ...
    private void displayFromSdcard() {
       ...
       // pdfFileName = fileList.get(position).getName();

        Log.e("tag","file path="+Environment.getExternalStorageDirectory() + "/"
                + "UserManual_DocFile" + "/" + "ME_Mobile_Help_File.pdf");
